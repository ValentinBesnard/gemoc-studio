...
[source,bourne]
----
docker build -t "dvojtise/gemoc-full-compilation:latest" .
---- 
...
[source,bourne]
----
docker run -it -v $PWD/../../../..:/home/ci/src -v $PWD/cache-m2:/home/ci/.m2 --user 1000 dvojtise/gemoc-full-compilation:latest ./build_gemoc.sh
---- 
...
[source,bourne]
----
docker run -it -v $PWD/../../../..:/home/ci/src -v $PWD/cache-m2:/home/ci/.m2 --user 1000 dvojtise/gemoc-full-compilation:latest ./build_gemoc.sh linux
---- 
or
[source,bourne]
----
...
docker run -v $PWD/../../../..:/home/jenkins/src -v $PWD/cache-m2:/home/jenkins/.m2 gemoc-full-compilation
----
...
[source,bourne]
----
docker run -it -v $PWD/../../../..:/home/jenkins/src -v $PWD/cache-m2:/home/jenkins/.m2 --user 1000 dvojtise/gemoc-full-compilation:latest /bin/bash
----
